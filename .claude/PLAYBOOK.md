...
**Why it matters**: Eliminates an entire category of deploy failures — Claude checks the _actual_ remote schema instead of guessing from local files. Catches NOT NULL columns, missing RLS, realtime publication gaps, and FK mismatches before they hit production.
